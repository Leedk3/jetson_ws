...
if __name__ == "__main__":
    ...
    filename = "/home/usrg/catkin_ws/src/cv_camera/test/sample_left.yaml"
    ...
    publisher = rospy.Publisher("/stereo/left/camera_info", CameraInfo, queue_size=10)
    pub_image = rospy.Publisher("/stereo/left/image_raw", Image, queue_size=10)
    sub_image = rospy.Subscriber("/left/raw",Image,callback_image)
    rate = rospy.Rate(30)
